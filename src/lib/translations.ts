export const translations = {
  tr: {
    ...
    appTitle: 'YolPay',
    appTagline: 'Akıllı Yolculuk & Yakıt Maliyeti',
    dataLabel: 'Veri',
    ...
    daysAgo: 'gün önce',
    routeLabel: 'Rota',
    openInMaps: 'Seçili rotayı Google Haritalar’da aç',
    openInMapsTitle: 'Seçili rotayı Google Haritalar’da aç',
    clearHistory: 'Temizle',
    clearHistoryTitle: 'Geçmişi temizle',
    setToHome: 'Kayıtlı ev adresimi getir',
    saveCurrentAsHome: 'Bu adresi Evim olarak kaydet',
    homeSavedSuccess: 'Ev adresiniz kaydedildi!',
    homeAddress: 'Kayıtlı Ev Adresi',
    homeAddressHint: 'Örn: Fit216 Kadıköy veya ev adresiniz',
    noHomeSavedPrompt: 'Kayıtlı ev adresi bulunamadı. Lütfen önce kutuya adresinizi yazıp "Ev olarak kaydet"e basın.',
    editHome: 'Ev adresini güncelle',
    ...
    estimatedConsumption: 'Tahmini Tüketim',
    officialConsumption: 'Fabrika verisi',
    trafficAdjusted: 'Trafiğe göre uyarlandı',
    trafficDataUnavailable: 'Trafik verisi yok',
    heavyTraffic: 'Yoğun trafik',
    trafficInfoTooltip: 'Aracınızın resmi fabrika tüketimi ve rotadaki anlık trafik koşulları kullanılarak tahmin edilmiştir.',
    personalAverage: 'Kişisel Tüketim',
    personalAverageHint: 'İsteğe bağlı: Gösterge ortalamanız',
    powertrain: 'Güç Ünitesi',
    mildHybrid: 'Mild Hibrit',
    fullHybrid: 'Tam Hibrit',
    phev: 'Plug-in Hibrit',
    ev: 'Elektrikli',
    lowestFuel: 'En Az Yakıt',
    ecoRoute: 'Ekonomik Rota',
    startTrip: 'Sürüşü Başlat',
    liveTrip: 'Canlı Sürüş',
    endTrip: 'Sürüşü Bitir',
    pauseTrip: 'Duraklat',
    resumeTrip: 'Devam Et',
    distanceTraveled: 'Gidilen Yol',
    currentSpeed: 'Anlık Hız',
    ...
    openVisualSelector: 'Görsel Katalogdan Seç',
    browseCarCatalog: 'Görsel Araç Kataloğu',
    changeCar: 'Aracı Değiştir',
    engineAndSegment: 'Motor & Segment',
    consumptionRange: 'Ortalama Tüketim',
    searchCar: 'Model veya marka ara...',
    allBrands: 'Tümü',
    selectYourCar: 'Aracınızı Seçin',
    carSelectorSubtitle: 'Yakıt tüketimi aracınızın fabrika verilerine göre anında hesaplanır.',
    selectedVehicle: 'Seçili Araç',
    customVehicleDesc: 'Kendi aracınızı ve tüketim değerinizi tanımlayın',
    applyAndSave: 'Seç ve Uygula',
  },
  en: {
    from: 'From?',
    to: 'To?',
    ...
    appTitle: 'YolPay',
    appTagline: 'Smart Trip & Fuel Cost',
    dataLabel: 'Data',
    ...
    daysAgo: 'd ago',
    routeLabel: 'Route',
    openInMaps: 'Open selected route in Google Maps',
    openInMapsTitle: 'Open selected route in Google Maps',
    clearHistory: 'Clear',
    clearHistoryTitle: 'Clear history',
    setToHome: 'Use saved home address',
    saveCurrentAsHome: 'Save this address as My Home',
    homeSavedSuccess: 'Home address saved!',
    homeAddress: 'Saved Home Address',
    homeAddressHint: 'e.g. Kadıköy, Istanbul or your address',
    noHomeSavedPrompt: 'No saved home address found. Type your address in the box and click "Save as Home" to save it.',
    editHome: 'Update home address',
    ...
    officialConsumption: 'Official Baseline',
    trafficAdjusted: 'Traffic adjusted',
    trafficDataUnavailable: 'Traffic data unavailable',
    heavyTraffic: 'Heavy traffic',
    trafficInfoTooltip: 'Estimated using your vehicle\'s official consumption and current route traffic conditions.',
    personalAverage: 'Personal Average',
    personalAverageHint: 'Optional: Your dashboard average',
    powertrain: 'Powertrain',
    mildHybrid: 'Mild Hybrid',
    fullHybrid: 'Full Hybrid',
    phev: 'Plug-in Hybrid',
    ev: 'Electric',
    lowestFuel: 'Lowest Fuel',
    ...
    openVisualSelector: 'Select from Visual Catalog',
    browseCarCatalog: 'Visual Car Catalog',
    changeCar: 'Change Vehicle',
    engineAndSegment: 'Engine & Segment',
    consumptionRange: 'Average Consumption',
    searchCar: 'Search model or brand...',
    allBrands: 'All',
    selectYourCar: 'Choose Your Vehicle',
    carSelectorSubtitle: 'Fuel consumption is calculated automatically based on your car model.',
    selectedVehicle: 'Selected Vehicle',
    customVehicleDesc: 'Define your custom vehicle and average fuel consumption',
    applyAndSave: 'Select & Apply',
  }
};
